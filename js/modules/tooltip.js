export default class Tooltip {
  ...
  onMouseMove(event) {
    ...
    if (event.pageX + 195 > window.innerWidth) {
  ...
  // cria a tooltip e adiciona os eventos mousemove e mouseleave ao target
  ...
  // adiciona os eventos de mouover a cada tooltip
